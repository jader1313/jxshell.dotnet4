...
namespace jxshell.net4
{
    ...
    public class VFPHelper
    {
        ...
        public Ast Compile()
        {
            ...
            foreach (KeyValuePair<string, jxshell.net4.methodDescriptor> staticMethod in typeD.staticMethods)
            {
            ...
            foreach (KeyValuePair<string, jxshell.net4.methodDescriptor> staticMethod in typeD.instanceMethods)
            {
