...
namespace jxshell.net4
{
	...
	public class wrapperStatic : wrapperBase
	{
        ...
        public static metaObject loadMetavalueFromType(Type t)
        {
            ...
            string name = jxshell.net4.typeDescriptor.getNameForType(t);
            m.value = t;
            m.isstatic = true; 
            m.typeDescriptor= jxshell.net4.typeDescriptor.loadFromType(t, name, false);
            m.name = name;
            return m; 
        }
		...
		public static wrapperStatic loadFromType(Type t)
		{
			...
			{
                var typed = jxshell.net4.typeDescriptor.loadFromType(t);
